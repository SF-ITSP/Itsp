...
public class ConnectionProxy {
    ...
    public enum RequestPath {
        ...
        public List<?> request(Context context, Map<String, String> parameter) throws IOException, JsonSyntaxException {
        ...
        public List<?> request(Context context) throws IOException, JsonSyntaxException {
            return request(context, null);
        }

        public List<?> convert(String dataAsJson) throws JsonSyntaxException {
